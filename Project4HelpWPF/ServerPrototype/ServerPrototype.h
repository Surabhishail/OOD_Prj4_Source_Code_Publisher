...
#include "../../CodePublisher_Pr2/Executive/Executive.h"
#include <windows.h>
#include <tchar.h>
...
namespace Repository
{
  ...
  const SearchPath storageRoot = "../../Project4HelpWPF";  // root for all server file storage
  ...
  public:
	...
	char * sysStrToCharArray(std::string str);
